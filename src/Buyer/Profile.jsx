  ...
  return (
    <div className="flex min-h-screen overflow-hidden bg-gray-100">
      ...
      <main className="flex-grow p-8 mt-14">
        <Link to="/properties">
          <button className="mb-6 flex items-center gap-2 px-5 py-2 bg-[#005555] text-white rounded hover:bg-[#007777] transition">
            <svg
      ...
      >
        <ProfileUpdateForm
          ...
          onSuccess={refetch} // refresh user after update
          loading={isLoading}
        />
      </Modal>
    </div>

        ...
        <div className="flex justify-start gap-3 mb-5">
          {LISTING_TYPES.map((type) => (
            <button
              ...
              className={`px-6 py-2.5 rounded-full font-semibold text-sm md:text-base transition-all duration-300 border ${filters.listingType === type.value
                ? "bg-[#00AAAA] text-white border-[#00AAAA] shadow-lg"
              ...
              >
                ...
                <div className="p-5 space-y-2">
                  ...
                  <div className="flex items-center text-gray-600 text-sm">
                    <MapPin size={16} className="mr-1 text-[#00AAAA]" />
                    {property.locality}, {property.city}
                  </div>

                  <div className="flex items-center text-gray-600 text-sm">
                    <Building2 size={16} className="mr-1 text-[#00AAAA]" />
                    {property.propertyType}
                  </div>

                  <div className="flex items-center justify-between mt-3">
                    {/* <p className="flex items-center text-[#004444] font-semibold text-lg">
                    ...
                    <button
                      ...
                      className="bg-[#004444] hover:bg-[#006666] text-white text-sm font-semibold px-4 py-2 rounded-lg transition-all"
                    >
                      View Details
                    </button>
                  </div>
